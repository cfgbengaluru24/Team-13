...
test('openwall', () => {
    ...
    expect(bcrypt.hashSync("09abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ09", "$2a$05$abcdefghijklmnopqrstuu")).toStrictEqual("$2a$05$abcdefghijklmnopqrstuu5s2v8.iXieOjg/.AySBTTZIIVFJeBui");
})
...
test('long_passwords', () => {
    ...
    expect(bcrypt.hashSync("0909090909090909090909090909090909090909090909090901234", "$2a$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2a$05$CCCCCCCCCCCCCCCCCCCCC.6.O1dLNbjod2uo0DVcW.jHucKbPDdHS")
    ...
    expect(bcrypt.hashSync("0909090909090909090909090909090909090909090909090901234", "$2b$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2b$05$CCCCCCCCCCCCCCCCCCCCC.XxrQqgBi/5Sxuq9soXzDtjIZ7w5pMfK")
    expect(bcrypt.hashSync("09090909090909090909090909090909090909090909090909012345", "$2b$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2b$05$CCCCCCCCCCCCCCCCCCCCC.XxrQqgBi/5Sxuq9soXzDtjIZ7w5pMfK")
})
...
test('shorten_salt_to_128_bits', () => {
    expect(bcrypt.hashSync("test", "$2a$10$999012")).toStrictEqual("$2a$10$99901u.OtL1A1eGK5wmvBKUDYKvuVKI7h2XBu")
